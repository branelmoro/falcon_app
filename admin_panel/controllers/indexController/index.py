...
class index(baseController):
	...
	def post(self, container):
		...
		if 'username' not in req.form_data or not req.form_data['username']:
			container.data['username_error'] = 'Please Enter username!'
			is_valid_input = False
		else:
			container.data['username'] = req.form_data['username']

		if 'password' not in req.form_data or not req.form_data['password']:
			container.data['password_error'] = 'Please Enter password!'
			is_valid_input = False
		...
		resp.body = self._render(view='login', container=container)
